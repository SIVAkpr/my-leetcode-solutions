...
Can you solve this real interview question? Find the Score Difference in a Game - You are given an integer array nums, where nums[i] represents the points scored in the ith game.
